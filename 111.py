...
def main():
    ...
    try:
        ...
        if cmdLineOptions.get("sqlmapShell"):
            ...
            main()
ctrip.product,ctrip.wireless,ctrip.weekend,ctrip.car,ctrip.ops,ctrip.communication,ctrip.luxury,ctrip.corp,ctrip.ttd,ctrip.flight
ctrip.framework,ctrip.hotel,ctrip.group,ctrip.train,ctrip.shopping,ctrip.tour,ctrip.frt,ctrip.getaway,ctrip.schedule,ctrip.gs
ctrip.cruise,ctrip.microfinance,ctrip.basebiz,ctrip.mice,ctrip.sysdev,ctrip.it,ctrip.market,ctrip.fun,ctrip.search,ctrip.ued,ctrip.toursforfun
ctrip.bus,ctrip.risk,ctrip.ibu,ctrip.payment,ctrip.cso,ctrip.sp,ctrip.tourtailor,ctrip.infosec,ctrip.skysea,ctrip.financialservice,ctrip.mtg,ctrip.account
ctrip.finance,ctrip.arch,ctrip.igt,ctrip.dcs,ctrip.di,ctrip.ccard.creditcard,ctrip.if,ctrip.ottd,bus,flight,hotel,IBU,train,com.ctrip
